...
![Table](medium-assets/02-prompt-engineering/table-0.png)
...
![Table](medium-assets/02-prompt-engineering/table-1.png)
...
Structured output prompting forces LLMs to respond in a specific format (JSON, XML, YAML, etc.). This is critical for programmatic consumption of LLM outputs.
...
![Table](medium-assets/02-prompt-engineering/table-2.png)
...
![Table](medium-assets/02-prompt-engineering/table-3.png)
